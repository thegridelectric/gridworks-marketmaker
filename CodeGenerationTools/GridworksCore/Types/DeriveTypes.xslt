        ...
        <FileSet>
            <FileSetFiles>
                ...
                <xsl:variable name="local-alias" select="AliasRoot" />
                    ...
                    <FileSetFile>
                                <xsl:element name="RelativePath"><xsl:text>../../../src/gwmm/schemata/</xsl:text>
...
<xsl:text>
import gwmm.property_format as property_format</xsl:text>
</xsl:if>
...
<xsl:text>
from gwmm.data_classes import </xsl:text><xsl:value-of select="DataClass"/>
</xsl:if>
</xsl:if>
...
<xsl:text>
from gwmm.property_format import predicate_validator</xsl:text>
</xsl:if>
<xsl:text>
...
<xsl:text>
from gwmm.enums import </xsl:text>
<xsl:call-template name="nt-case">
...
<xsl:text>
    ...
    def dc_to_tuple(cls, dc: </xsl:text><xsl:value-of select="DataClass"/><xsl:text>) -> </xsl:text><xsl:value-of select="$class-name"/><xsl:text>:
        ...
        <xsl:call-template name="python-case">
            <xsl:with-param name="camel-case-text" select="Value"  />
        </xsl:call-template><xsl:text>)id=dc.</xsl:text>
        <xsl:call-template name="python-case">
            <xsl:with-param name="camel-case-text" select="Value"  />
